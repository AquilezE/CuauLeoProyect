...
namespace Cliente.ServiceReference {
    ...
    public interface IProfileManager {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Cliente.ServiceReference.BevososServerExceptions), Action="http://tempuri.org/IProfileManager/ChangePasswordBevososServerExceptionsFault", Name="BevososServerExceptions", Namespace="http://schemas.datacontract.org/2004/07/BevososService.Exceptions")]
        int ChangePassword(int userId, string oldPassword, string newPassword);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProfileManager/ChangePassword", ReplyAction="http://tempuri.org/IProfileManager/ChangePasswordResponse")]
        System.Threading.Tasks.Task<int> ChangePasswordAsync(int userId, string oldPassword, string newPassword);
    }
    ...
    public partial class ProfileManagerClient : System.ServiceModel.ClientBase<Cliente.ServiceReference.IProfileManager>, Cliente.ServiceReference.IProfileManager {
        ...
        public System.Threading.Tasks.Task<int> ChangePasswordAsync(int userId, string oldPassword, string newPassword) {
