...
namespace Cliente.ServiceReference {
    ...
    public interface ISocialManager {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISocialManager/SendFriendRequest", ReplyAction="http://tempuri.org/ISocialManager/SendFriendRequestResponse")]
        System.Threading.Tasks.Task<bool> SendFriendRequestAsync(int userId, string requesteeUserName);
    ...
    public partial class SocialManagerClient : System.ServiceModel.DuplexClientBase<Cliente.ServiceReference.ISocialManager>, Cliente.ServiceReference.ISocialManager {
        ...
        public bool SendFriendRequest(int userId, string requesteeUserName) {
            return base.Channel.SendFriendRequest(userId, requesteeUserName);
        }
        
        public System.Threading.Tasks.Task<bool> SendFriendRequestAsync(int userId, string requesteeUserName) {
            return base.Channel.SendFriendRequestAsync(userId, requesteeUserName);
        }
